...
function seleccionarProyecto() {
    ...
    let nombre_proyecto = proyecto.value;
        ...
        img.src = 'https://peverdemarketing.com/wp-content/uploads/2022/10/Golf1.png';
        ...
        const img = document.createElement('img'); 
        img.src = 'https://peverdemarketing.com/wp-content/uploads/2022/10/Mar1.png'; 
        ...
        const img = document.createElement('img');
        img.src = 'https://peverdemarketing.com/wp-content/uploads/2022/10/Vitacura1.png';
        document.querySelector('#imagenProyectoDom').appendChild(img);
